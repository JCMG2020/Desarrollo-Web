...
namespace ProyectoFinal.App_Code.Dal
{
    public class ClsConexion
    {
        ...
        public bool ejecutarNonQuery(string dbQuery)
        {
            ...
            using (SqlCommand cmd = getCommnad(dbQuery, con))
            {
                try
                {
        ...
        //Metodo que ejecuta una sentencia SQL retornando un valor 
        public object ejecutarEscalar(string dbQuery, bool esStoreProc = false)
        {
